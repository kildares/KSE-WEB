...
joint.shapes.uml.Class = joint.shapes.basic.Generic.extend({
    ...
    addAttribute: function(attribute){
        var att = this.get('attributes');
        att.push(attribute);
        this.set('attributes',0);
        this.set('attributes',att);
    },
    
    removeAttribute: function(attribute){
        var att = this.get('attributes');
        att.splice(att.indexOf(attribute),1);
        //att.push(attribute);
        this.set('attributes',0);
        this.set('attributes',att);
    },
    ...
    addMethod: function(method){
        var mtd = this.get('methods');
        mtd.push(method);
        this.set('methods',0);
        this.set('methods',mtd);
    },
    
    removeMethod: function(method){
        var mtd = this.get('methods');
        mtd.splice(mtd.indexOf(method),1);
        //att.push(attribute);
        this.set('methods',0);
        this.set('methods',mtd);
    },
    ...
    updateRectangles: function() {
        ...
        var offsetY = 0;
        console.log("atributos: "+rects[1].text);
...
joint.shapes.uml.Association = joint.dia.Link.extend({
    ...
    //Funcao criada para gerar uma cardinalidade entre os elementos da associacao
    cardinality: function(value) {
        this.set('labels', [{ position: -20, attrs: { text: { dy: -8, text: value }}}]);
    }
});
